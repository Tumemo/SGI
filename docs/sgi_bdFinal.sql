...
CREATE TABLE IF NOT EXISTS `sgi`.`jogos` (
  ...
  `tempo_restante_jogo` INT(11) NULL DEFAULT NULL COMMENT 'Segundos restantes salvos no ultimo snapshot (pausa/save)',
  `duracao_jogo` INT(11) NULL DEFAULT NULL COMMENT 'Duracao total programada em segundos',
  `tempo_extra_jogo` INT(11) NOT NULL DEFAULT 0 COMMENT 'Total de segundos extras (acrescimos/prorrogacao)',
  `data_inicio_real` DATETIME NULL DEFAULT NULL COMMENT 'Data/hora do inicio real da partida (iniciar ou retomar)',
