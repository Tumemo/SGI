...
Antes dos lotes de telas finais, as seis fontes CSS auditadas totalizavam 75.954 bytes e 2.512 linhas. O lote do shell do chaveamento reduziu o total para 73.087 bytes e 2.422 linhas; o lote da timeline e da limpeza de seção órfã reduziu para 72.329 bytes e 2.412 linhas; o sublote visual da árvore reduziu o total para 66.089 bytes e 2.232 linhas; o lote do pódio individual e da remoção do alias de animação reduziu o total para 65.716 bytes e 2.221 linhas; o lote de modalidades e destaques reduziu o total para 56.898 bytes e 1.826 linhas; o lote do layout interno do placar reduziu o total para 55.853 bytes e 1.812 linhas; este lote da timeline reduz o total para 54.085 bytes e 1.792 linhas, uma redução adicional de 1.768 bytes (3,17%) e 20 linhas (1,10%). Em relação à base fixa registrada acima, a redução acumulada é de 21.869 bytes (28,79%) e 720 linhas (28,66%). A medição continua separada dos bundles Bootstrap e do SCSS próprio.
