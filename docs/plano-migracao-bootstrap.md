...
Permanecem para os próximos lotes a revisão final da pontuação avançada, a timeline e a geometria restante do placar/árvore, a auditoria das exceções customizadas restantes e as referências Linux do contrato visual. Agenda, locais/regulamento, modalidades, controles de pontuação, o pódio individual e o layout base do confronto já foram tratados. Na agenda e no chaveamento, permanecem somente geometria, conectores e acentos sem equivalente Bootstrap como exceções documentadas; dimensões de toque, números do placar, timeline e layout avançado continuam sob revisão. A migração global só será marcada como concluída quando as pendências forem tratadas, cada exceção estiver justificada e houver referências para o contrato visual.
