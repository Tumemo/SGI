...
{
    public function testSplitsGamesAtDailyCutoffAndSuggestsThursday(): void
    {
        ...
        $result = $scheduler->simulate(
            ...
            [
                ...
                ['data' => '2026-09-17', 'inicio' => '08:00', 'fim' => '11:30', 'local' => 1],
            ],
            [],
            ['duracao_min' => 60],
        );
        ...
        self::assertSame('2026-09-17', $result['proposta'][3]['data_jogo']);
        self::assertSame('11:30', $result['limite_termino_padrao']);
    }

    public function testReportsNextSessionWhenOnlyFirstTuesdayIsProvided(): void
    {
        ...
        self::assertSame('2026-09-17', $result['proximo_dia_sugerido']);
    ...
    public function testRequiresTuesdayThenThursdayCadence(): void
    {
    ...
    public function testCalculatesAlternatingDates(): void
    {
        $scheduler = new AgendamentoSequencialScheduler();

        self::assertSame('2026-09-17', $scheduler->nextSessionDate('2026-09-15'));
        self::assertSame('2026-09-22', $scheduler->nextSessionDate('2026-09-17'));
        self::assertSame('2026-09-15', $scheduler->firstSessionDate('2026-09-09'));
    }
}
