...
class HistoricoTurmaAndClassificacaoTest
{
    public static function run(int $idEdicao, int $idTurma, int $idModalidade): void
    {
        ...
        $resHist = $admin->get("api/v1/historico-turma?id_turma=$idTurma&id_interclasse=$idEdicao");
        ...
        $resHistSemParam = $admin->get("api/v1/historico-turma");
        ...
        $resClassif = $admin->get("api/v1/classificacao?id_modalidade=$idModalidade");
        ...
        $resTipos = $admin->get("api/v1/tipos-modalidade");
