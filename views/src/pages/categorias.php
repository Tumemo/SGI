...
<main class="position-relative d-md-none" style="margin-bottom: 120px;">
    ...
    <p class="text-secondary text-center my-3" style="font-size: 14px;">Categorias do interclasse</p>
...
<script>
    ...
    const isColaborador = <?= json_encode($isColaborador) ?>;
    const isMesario = <?= json_encode($isMesario) ?>;
