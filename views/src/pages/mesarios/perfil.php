...
<main class="d-md-none p-3" style="padding-top: 5.5rem; padding-bottom: 5rem;">
    ...
    <div class="mb-3">
        <div class="perfil-label">Matrícula</div>
        <div class="perfil-valor" id="perfilMatriculaMob"><?= htmlspecialchars($usuarioPerfil['matricula_usuario'] ?? '', ENT_QUOTES) ?></div>
    </div>
    <div class="mb-4">
    ...
    <div class="container-fluid px-2 px-md-4 py-4">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    <div class="perfil-label">Matrícula</div>
                    <div class="perfil-valor" id="perfilMatriculaDesk"><?= htmlspecialchars($usuarioPerfil['matricula_usuario'] ?? '', ENT_QUOTES) ?></div>
                </div>
                <div class="mb-4">
                    <div class="perfil-label">Senha</div>
                    <div class="perfil-valor">********</div>
