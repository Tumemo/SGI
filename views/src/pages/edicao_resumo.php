...
<main class="mt-4 d-flex justify-content-center align-items-center flex-column position-relative d-md-none sgi-inline-80857b05" >
    ...
    <section class="d-flex gap-4 mt-3 position-fixed translate-middle sgi-inline-2839521f" >
        <a href="./edicao_pontuacao.php" id="btnVoltarMobile" class="btn btn-danger d-inline-flex align-items-center gap-2 fw-bold mb-4 px-3 py-2 border-0 text-decoration-none sgi-inline-e1bcebb6" >
...
<main class="d-none d-md-block main-desktop-layout">
    ...
    <div class="container-fluid px-0 sgi-inline-5a236b22" >
        ...
        <div class="mb-5">
            <a href="./edicao_pontuacao.php" id="btnVoltarResumoTopo" class="btn btn-danger d-inline-flex align-items-center gap-2 fw-bold mb-4 px-3 py-2 border-0 text-decoration-none sgi-inline-e1bcebb6" >
    ...
    <div class="d-none d-md-block fixed-bottom sgi-inline-676cd221" >
        <div class="container-fluid d-flex justify-content-end align-items-center gap-3 sgi-inline-5a236b22" >
            <a href="./edicao_pontuacao.php" id="btnVoltarDesktop" class="btn btn-danger d-inline-flex align-items-center gap-2 fw-bold mb-4 px-3 py-2 border-0 text-decoration-none sgi-inline-e1bcebb6" >
