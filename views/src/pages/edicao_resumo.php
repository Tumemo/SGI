...
<main class="mt-4 d-flex justify-content-center align-items-center flex-column position-relative" style="margin-bottom: 120px;">
    <a href="./edicao_modalidades.php" class="text-decoration-none text-dark">
        <div class="m-auto shadow d-flex justify-content-between align-content-center px-3 py-3 rounded-3 border border-1  " style="width: 90%;">
            <div>
                <h2 class="m-0 fs-4">Modalidades</h2>
                <p class="text-secondary m-0 fs-6 mt-1">(Queimada, Futebol, Quatro base, Vôlei, Just dance)</p>
            </div>
        </div>
    </a>
    ...
    <a href="./edicao_regulamentos.php" class="text-decoration-none text-dark">
        <div class="m-auto shadow d-flex justify-content-between align-content-center px-3 py-3 rounded-3 my-3 border border-1  " style="width: 90%;" ${item.id_interclasse}>
            <div>
                <h2 class="m-0 fs-4">Regulalmentos</h2>
                <p class="text-secondary m-0 fs-6 mt-1">(1° ano EM, 2° ano EM, 3° ano EM, 9° ano, 8° ano, 7° ano)</p>
            </div>
        </div>
    </a>
