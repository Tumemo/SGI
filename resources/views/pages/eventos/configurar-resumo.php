...
<main class="mt-4 d-flex justify-content-center align-items-center flex-column position-relative d-md-none mb-5" >
...
<main class="d-none d-md-block main-desktop-layout">
        ...
        <div class="d-flex flex-column gap-3 mb-5">
            <a href="<?= \App\Shared\Http\Url::to('edicoes/modalidades') ?>" id="linkEditarModalidadesDesktop" class="text-decoration-none">
                <div class="bg-white border-0 shadow-sm rounded-2 p-4 d-flex flex-column justify-content-center h-100 sgi-u-cursor-pointer">
                    ...
                    <span class="text-secondary text-truncate small" id="resumoModalidadesDesktop" >
                        (Carregando...)
                    </span>
                </div>
            </a>
            ...
            <a href="<?= \App\Shared\Http\Url::to('edicoes/pontuacao') ?>" id="linkEditarRegulamentosDesktop" class="text-decoration-none">
                <div class="bg-white border-0 shadow-sm rounded-2 p-4 d-flex flex-column justify-content-center h-100 sgi-u-cursor-pointer">
                    ...
                    <span class="text-secondary text-truncate small" id="resumoRegulamentosDesktop" >
                        (Carregando...)
                    </span>
                </div>
            </a>
    ...
    <div class="d-none d-md-block fixed-bottom bg-light py-4" >
        <div class="container-fluid d-flex justify-content-end align-items-center gap-3 mw-100" >
