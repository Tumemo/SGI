...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', async function () {
        ...
        document.getElementById('btn-prev').addEventListener('click', () => navegarMes(-1));
        document.getElementById('btn-next').addEventListener('click', () => navegarMes(1));
        document.getElementById('btn-prev-mobile').addEventListener('click', () => navegarMes(-1));
        document.getElementById('btn-next-mobile').addEventListener('click', () => navegarMes(1));
        ...
        document.getElementById('calendario-grade').addEventListener('click', (e) => {
            const target = e.target.closest('[data-date]');
            if (target) aplicarFiltroData(target.dataset.date);
        });
        document.getElementById('calendario-grade-mobile').addEventListener('click', (e) => {
            const target = e.target.closest('[data-date]');
            if (target) aplicarFiltroData(target.dataset.date);
        });
        ...
        document.getElementById('btn-mostrar-todos').addEventListener('click', limparFiltro);
        document.getElementById('btn-mostrar-todos-mobile').addEventListener('click', limparFiltro);
