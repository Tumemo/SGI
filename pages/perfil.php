    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        (async () => {
            try {
                ...
                if (data.success && data.foto_usuario) mostrarFoto('../../../uploads/fotosUsuarios/' + data.foto_usuario);
            } catch (e) {
        ...
        input.addEventListener('change', async () => {
            ...
            try {
                ...
                const data = await resp.json();
                if (data.success && data.arquivo) mostrarFoto('../../../uploads/fotosUsuarios/' + data.arquivo);
