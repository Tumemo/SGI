...
return [
    'aliases' => [
        ...
        '/api/historico_turma.php' => '/api/v1/historico-turma',
        '/api/inscricao.php' => '/api/v1/inscricoes',
        '/api/jogos.php' => '/api/v1/jogos',
        '/api/lancar_resultado.php' => '/api/v1/resultados',
        '/api/partidas.php' => '/api/v1/partidas',
        '/api/sincronizar_chaveamento.php' => '/api/v1/sincronizacao/chaveamento',
        '/api/usuarios.php' => '/api/v1/usuarios',
    ],
    'endpoints' => [
    ],
];
